...
export default function ProjectsSection() {
  ...
  return (
    <section className="projects max-w-5xl mx-auto px-4 sm:px-8 py-8 sm:py-12">
      <div className="flex flex-row gap-4 justify-between items-center pb-6 sm:pb-12">
        <div className="">
        ...
        <Link
          to="/project"
          className="group flex gap-0 items-center text-amber-300 hover:text-amber-400 "
        >
          <span className="hidden sm:block uppercase text-base sm:text-lg md:text-xl font-medium transition duration-500 ease-in-out hover:translate-x-0.5">
            View all
          </span>
          <ChevronRightIcon className="h-10 sm:h-9 md:h-10 transition duration-500 ease-in-out group-hover:scale-110" />
        </Link>
      </div>
